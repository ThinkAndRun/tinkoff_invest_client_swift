...
open class RequestBuilder<T> {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:]) {
        ...
        addHeaders(TinkoffInvestClientAPI.customHeaders)
    }
    ...
    open func execute(_ apiResponseQueue: DispatchQueue = TinkoffInvestClientAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, Error>) -> Void) { }
    ...
    open func addCredential() -> Self {
        credential = TinkoffInvestClientAPI.credential
        return self
    }
}
